...
const DISCONNECTED: ConnectionSnapshot = { connected:false,endpoint:null,database:null,mysqlVersion:null,tls:false,profileId:null,connectionRevision:0,schemaRevision:0,dataRevision:0 };

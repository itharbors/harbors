...
const DEFAULT_POLICY: PolicyV1 = {
  ...
  dynamicWarning: {
    ...
    corroborators: { sessionsPerMinute: 6, tasksPerMinute: 6, connectionsPerMinute: 12 },
  },
  fixedWarning: { outboundMiB: 128, sessionsOrTasks: 20 },
  fixedTrip: { outboundMiB: 512, sessionsOrTasks: 50, minimumConfidence: 'confirmed' },
  structuralTrip: {
    recursiveDepth: 6,
    recursiveTasks: 24,
    recursiveWindowSeconds: 60,
    burstTasks: 30,
    burstActiveTasks: 16,

...
new_fixture() {
  ...
  unset NPM_FAIL GH_AUTH_FAIL GH_OPEN_PR_COUNT GH_REPO_OWNER GH_VIEW_NUMBER GH_VIEW_BASE GH_VIEW_HEAD GH_VIEW_STATE GH_VIEW_URL GH_VIEW_HEAD_OID GH_VIEW_STALE_HEAD GH_CREATE_URL GIT_FAIL_PUSH_NUMBER GIT_FAIL_STATUS_COMMIT GIT_CONFIG_GLOBAL HARBORS_KIT_RELEASE_CONFIRM

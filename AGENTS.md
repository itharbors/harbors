# Harbors SQLite Kit repository instructions

Use the repository-local `kit-workflow` Skill for every product change. Base and PR target must remain `kit/sqlite`; never target `main`.

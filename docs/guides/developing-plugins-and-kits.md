...
Default 是唯一的 builtin Kit。CSV、SQLite、MySQL、Notifications 与 TraceWeave 是官方市场 Kit；其实现固定保存在
主分支的 `kits/csv`、`kits/sqlite`、`kits/mysql`、`kits/notifications`、`kits/traceweave`，这些仓库目录只会由

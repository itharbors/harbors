...
Default、CSV、SQLite、MySQL、Notifications 和 Skill Manager，不需要先从市场安装。开发源码与 active 商城 Kit
...
CSV、SQLite、MySQL、Notifications 和 Skill Manager 分别保存在 `kits/csv`、`kits/sqlite`、`kits/mysql`、
